...
class TeamBatteryLoan(models.Model):
    ...
    battery_1_returned_at = models.DateTimeField(null=True)
    battery_2_returned_at = models.DateTimeField(null=True)
    charger_returned_at = models.DateTimeField(null=True)
    charger_psu_returned_at = models.DateTimeField(null=True)
