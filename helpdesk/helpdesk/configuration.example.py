...
# Specify one or more name and email address tuples representing Helpdesk administrators. These people will be notified of
# application errors (assuming correct email settings are provided).
ADMINS: List[Tuple[str, str]] = [
    # ('John Doe', 'jdoe@example.com'),
]

# Base URL path if accessing Helpdesk within a directory. For example, if installed at https://example.com/helpdesk/, set:
# BASE_PATH = 'helpdesk/'
BASE_PATH = ''
