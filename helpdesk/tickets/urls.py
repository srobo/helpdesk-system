...
from .views import TicketQueueDetailView, RedirectToDefaultTicketQueue, TicketDetailView, AssignedTicketListView

app_name = "tickets"

urlpatterns = [
    path("", RedirectToDefaultTicketQueue.as_view(), name="queue_default"),
    path("assigned-to-me", AssignedTicketListView.as_view(), name="ticket_assigned_list"),
